...
public class Main {
    ...
    /**
     * Devuelve el valor del número entero positivo menor estricto que
     * 1_000_000 que tiene asociada la secuencia de Collatz más larga.
     *
     * @return el valor del número entero positivo menor estricto que
     *         1_000_000 que tiene asociada la secuencia de Collatz más
     *         larga.
     */
    public static long iniciadorSecuenciaMasLarga() {
        return iniciadorSecuenciaMasLarga(LIMITE);
    }
    ...
    public static void main(String[] args) {
        System.out.println(iniciadorSecuenciaMasLarga());
    }
}
